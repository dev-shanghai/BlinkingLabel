...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Asim Khan/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Asim Khan' => '11mdswe0371@uetpeshawar.edu.pk' }
  s.source           = { :git => 'https://github.com/Asim Khan/BlinkingLabel.git', :tag => s.version.to_s }
